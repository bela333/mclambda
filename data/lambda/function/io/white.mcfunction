...
execute unless score num1 lambda matches 4 run tellraw @a "white's x argument was not a number"
...
scoreboard players set rewindsteps lambda 0
execute store result score num1 lambda run data get storage lambda:lambda current[0]
execute unless score num1 lambda matches 4 run tellraw @a "white's y argument was not a number"
execute unless score num1 lambda matches 4 run return fail
...
scoreboard players set rewindsteps lambda 0
execute store result score num1 lambda run data get storage lambda:lambda current[0]
execute unless score num1 lambda matches 4 run tellraw @a "white's z argument was not a number"
execute unless score num1 lambda matches 4 run return fail
data modify storage lambda:lambda stack[2] set from storage lambda:lambda current[1]
# stack: x res, y res, z res
data modify storage lambda:lambda args set value {name:"minecraft:white_wool"}
