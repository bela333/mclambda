...
execute unless score num1 lambda matches 4 run tellraw @a "first argument of `ashr` was not a number"
execute unless score num2 lambda matches 4 run tellraw @a "second argument of `ashr` was not a number"
...
function lambda:utils/shift_right
