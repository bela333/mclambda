data modify storage lambda:lambda temp set value [0, [0, x, [0, y, w]], [0, z, w]]
#w
data modify storage lambda:lambda temp[1][2][2] set from storage lambda:lambda current[2]
...
#y
data modify storage lambda:lambda temp[1][2][1] set from storage lambda:lambda current[1][1][2]
#x
