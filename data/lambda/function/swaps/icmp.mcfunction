...
execute unless score num1 lambda matches 4 run tellraw @a "first argument of `icmp` was not a number"
execute unless score num2 lambda matches 4 run tellraw @a "second argument of `icmp` was not a number"
...
# EQ: K K : [0, [2], [2]]
# GT: K A : [0, [2], [7]]
execute if score num1 lambda < num2 lambda run data modify storage lambda:lambda current set value [18]
execute if score num1 lambda = num2 lambda run data modify storage lambda:lambda current set value [0, [2], [2]]
execute if score num1 lambda > num2 lambda run data modify storage lambda:lambda current set value [0, [2], [7]]
